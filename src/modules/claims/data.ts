...
export const claims: Claim[] = [
  ...
  },
  {
    ...
    aiSuggestions: [{ type: 'modifier', add: '-95', reason: 'Telehealth modifier required for Medicare' }],
    timeInStage: '4h',
    isResubmission: false,
    memberId: 'MEM-006',
    phone: '(555) 222-3333',
  ...
  },
  {
    ...
    aiSuggestions: [{ type: 'modifier', add: '-59', reason: 'Distinct procedural service' }],
    timeInStage: '3h',
    isResubmission: true,
